...
a persistence unit "PFinalPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "PFinal/pom.xml":
...
artifact ("PFinal.war") is already built. You can build
